...
This module centrally maintains all chapter-level Schema and text representations for prompts,
ensuring chapter generation, validation, and rendering share a unified understanding of the structure.
"""
        ...
        {"type": "string"},
        {
            ...
            "properties": {
                ...
                "impact": {
                    "type": "string",
                    "enum": ["低", "中低", "中", "中高", "高", "极高"],
                    "description": "Impact rating, only allowed values: Low/Medium-Low/Medium/Medium-High/High/Very High",
                },
                # "score": {
                #     "type": "number",
                #     "minimum": 0,
                #     "maximum": 10,
                #     "description": "Score, only numbers 0-10 allowed",
                # },
        ...
        {"type": "string"},
        {
            ...
            "properties": {
                ...
                "trend": {
                    ...
                    "description": "Trend/impact assessment, only allowed values: Positive/Negative/Neutral/Uncertain/Under Observation",
                },
...
pest_block: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "economic": {
            "type": "array",
            "items": {"$ref": "#/definitions/pestItem"},
            "description": "Economic factors: economic cycles, interest rates, exchange rates, consumption levels, etc.",
        },
        "social": {
            "type": "array",
            "items": {"$ref": "#/definitions/pestItem"},
            "description": "Social factors: population structure, cultural trends, lifestyle patterns, etc.",
        },
        "technological": {
            "type": "array",
            "items": {"$ref": "#/definitions/pestItem"},
...
engine_quote_block: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "engine": {"type": "string", "enum": ["media", "query"]},
        "title": {"type": "string"},
        "blocks": {
            "type": "array",
            "items": {"$ref": "#/definitions/block"},
