...
class MathToSVG:
    """Converter for transforming LaTeX math formulas to SVG"""
    ...
    def convert_to_svg(self, latex: str, display_mode: bool = True) -> Optional[str]:
        ...
        Returns:
            SVG string, returns None if conversion fails
        """
        try:
            ...
            for pat in patterns:
                ...
                if m:
                    ...
                    break
            # Clean control characters and common compatibility fixes
            ...
            # Convert to inches (matplotlib's unit)
...
def convert_math_block_to_svg(
    ...
    """
    Convenience function: Convert math formula block to SVG
...
def convert_math_inline_to_svg(
    ...
    """
    Convenience function: Convert inline math formula to SVG
