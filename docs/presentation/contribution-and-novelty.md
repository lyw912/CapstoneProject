...
| Multi-agent reasoning | Runs active Query and Media subgraphs under a typed parent supervisor, with one Evidence Blackboard and evidence-ID-bound audit rather than free-form agent chat. | `AgentCoordinator/fusion/`, `AgentCoordinator/intelligence/evidence_core/`, [AgentCoordinator](../components/agent-coordinator.md) |
| Evidence pipeline | Keeps Query stance breadth and Media narrative/multimodal depth, while canonical sources, acquisitions, quality, claims, relations, and coverage share one contract. | `QueryEngine/contribution.py`, `MediaEngine/contribution.py`, `AgentCoordinator/intelligence/contracts/` |
...
| Agent and intelligence implementation | `AgentCoordinator/fusion/`, `AgentCoordinator/intelligence/evidence_core/`, `QueryEngine/graph/`, `MediaEngine/graph/`, `ReportEngine/graph/` |
