...
class BertModel_Custom(BaseModel):
    ...
    def _download_bert_model(self):
        ...
        print(f"BERT model does not exist, downloading Chinese BERT pre-trained model...")
        ...
        try:
            ...
            # Use Chinese BERT model from Hugging Face
    ...
    def _load_bert(self):
        ...
        try:
            ...
            try:
                ...
                raise FileNotFoundError(f"Unable to load BERT model, please check network connection or manually download model to: {self.model_path}")
    ...
    def save_model(self, model_path: str = None) -> None:
        """Save model"""
        if not self.is_trained:
            raise ValueError(f"Model {self.model_name} is not trained, cannot save")
