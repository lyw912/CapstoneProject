...
class Qwen3EmbeddingUniversal(BaseQwenModel):
    ...
    def train(self, train_data: List[Tuple[str, int]], **kwargs) -> None:
        """Train model"""
        print(f"Starting training of Qwen3-Embedding-{self.model_size} model...")
...
def main():
    ...
    if not args.model_size:
        ...
        print("  1. 0.6B - Lightweight, fast training, requires ~4GB VRAM")
        print("  2. 4B  - Medium scale, balanced performance, requires ~16GB VRAM")
        print("  3. 8B  - Large scale, best performance, requires ~32GB VRAM")
    ...
    if args.eval_only:
        ...
        # Sample predictions
        print(f"\nQwen3-Embedding-{args.model_size} Sample Predictions:")
        test_texts = [
            "今天天气真好，心情很棒",
            "这部电影太无聊了，浪费时间", 
            "哈哈哈，太有趣了"
