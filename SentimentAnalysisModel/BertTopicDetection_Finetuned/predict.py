...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Predict using local/cached/remote Chinese BERT classification model")
    ...
    parser.add_argument("--text", type=str, default=None, help="Directly input a text for prediction")
...
def main() -> None:
    ...
    # Default to interactive mode (when --text is not explicitly specified and interactive is not explicitly disabled)
