    ...
    def run(self, input_data: Any, **kwargs) -> str:
        ...
        try:
            if not self.validate_input(input_data):
                raise ValueError("Input data format error, requires a list with title and paragraph_latest_state")
        ...
        try:
            ...
            if len(paragraphs_data) > 1:
                report_lines.extend([
                    ...
                    "The various aspects covered above provide important reference for understanding this topic.",
                    ""
                ])
