...
try:
    ...
    logger.warning("Warning: Unable to import forum_reader module, will skip HOST speech reading functionality")
...
class FirstSummaryNode(StateMutationNode):
    ...
    def run(self, input_data: Any, **kwargs) -> str:
        ...
        try:
            ...
            # If HOST speech exists, add it to the beginning of the message as reference
