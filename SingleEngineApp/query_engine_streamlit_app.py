...
def main():
    ...
    st.markdown("Broadly crawls official reports and news, combining domestic and international resources for public opinion analysis")
    ...
    if start_research:
        ...
        # Since using DeepSeek, check related API keys
