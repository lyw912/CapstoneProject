"""
日志监控器 - 实时监控 Media/Query 两个 log 文件中的 SummaryNode 输出
"""
...
class LogMonitor:
    ...
    def is_target_log_line(self, line: str) -> bool:
        ...
        2. 完整模块路径：MediaEngine.nodes.summary_node、QueryEngine.nodes.summary_node
                    ...
                    if current_lines > previous_lines:
                        ...
                        if self.is_searching:
                            ...
                            for content in captured_contents:
                                # 将app_name转换为大写作为标签（如 media -> MEDIA）
