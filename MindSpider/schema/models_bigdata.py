"""
Public Opinion Big Data Aggregation Main Table ORM Model (Automatically generated from tables.sql structure,
for bulk search and content storage)
...
- This module (Automatic SQL table mapping, compatible with MySQL/PostgreSQL, recommended to manually complete comments, unique/index constraints)
- MindSpider/schema/models_sa.py  # Base definition source

This module follows MindSpider\DeepSentimentCrawling\MediaCrawler\database\models.py as the standard
"""
