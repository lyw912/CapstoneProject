...
class FirstSummaryNode(StateMutationNode):
    """Node for generating first summary of paragraph based on search results"""
    ...
    def run(self, input_data: Any, **kwargs) -> str:
        ...
        try:
            ...
            # Call LLM to generate summary (streaming, safe UTF-8 concatenation)
    ...
    def mutate_state(self, input_data: Any, state: State, paragraph_index: int, **kwargs) -> State:
        """
        Update latest summary of paragraph to state
