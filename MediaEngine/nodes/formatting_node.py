...
class ReportFormattingNode(BaseNode):
    ...
    def run(self, input_data: Any, **kwargs) -> str:
        """
        Call LLM to generate Markdown format report
        ...
        try:
            ...
            # Call LLM to generate Markdown format (streaming, safe UTF-8 concatenation)
        ...
        try:
            ...
            if len(paragraphs_data) > 1:
                report_lines.extend([
                    ...
                    "The various aspects covered above provide important references for understanding this topic.",
                    ""
                ])
