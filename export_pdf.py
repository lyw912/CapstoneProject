...
# Add project path to sys.path (modify this path to your project directory)
...
def export_pdf(ir_file_path):
    ...
    try:
        ...
        output_dir = Path('./final_reports/pdf')
...
if __name__ == "__main__":
    # Use the latest report file (modify this path to your actual report file)
    latest_report = "./final_reports/ir/report_ir_example.json"
